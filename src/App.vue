  ...
  <div class="counter" >
    ...
    <div class="info">
      ...
      <div class="additional__info">
        <div class="info__block">
          <button class="info__btn">{{ correctWordCount }}</button>
          <p>Words/min</p>
        </div>
        <div class="info__block">
          <button class="info__btn">{{ charCount }}</button>
          <p>Chars/min</p>
        </div>
      </div>
    </div>
    <div class="input">
      <transition name="fade">
        <div class="input__indicator" v-if="!timerRunning">
          Start typing
        </div>
      </transition>
      <input
          ...
          v-if="inputFocused" />
      <span class="word-to-type">{{ words[currentIndex] }}</span>
    </div>
    <div class="modal-wrapper" v-if="timerCount === 0 && showModal">
      <div class="modal">
        <div class="modal__img">
          <svg width="264" height="200" viewBox="0 0 264 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              ...
              <clipPath id="clip1">
                <path fill="#fff" transform="translate(1 -1)" d="M0 0h263.8v199.4H0z"/>
              </clipPath>
            </defs>
          </svg>
        </div>
        <div class="modal__info">
          <h2>You're an Octopus!</h2>
          <p>Well... You type with speed of <span> {{correctWordCount}} WPM </span>
            <br/>
            It could be better!
          </p>
          <button class="modal__btn" @click="tryAgain">Try again</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    calculateSpeed() {
      const elapsedMinutes = (60 - this.timerCount) / 60;
      this.minuteWordCount = Math.round(this.correctWordCount / elapsedMinutes);
      this.minuteCharCount = Math.round(this.charCount / elapsedMinutes);
      this.wordCount = this.currentIndex / elapsedMinutes;
      this.showModal = true
    ...
    handleInput() {
      ...
      if (this.typedText.trim() === currentWord) {
        this.currentIndex++;
